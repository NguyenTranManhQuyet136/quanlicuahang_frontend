...
import { FiPackage as FiPackageBase, FiCheckCircle as FiCheckCircleBase, FiClock as FiClockBase, FiTruck as FiTruckBase, FiLoader as FiLoaderBase } from 'react-icons/fi';
...
const FiLoader = FiLoaderBase as any;
        ...
        const fetchOrders = async () => {
            ...
            try {
                ...
                for (const order of orderList) {
                    ...
                    const items = detailRes.data.map((row: any) => ({
                        name: row.name,
                        image: row.image,
                ...
                fullOrders.sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime());
