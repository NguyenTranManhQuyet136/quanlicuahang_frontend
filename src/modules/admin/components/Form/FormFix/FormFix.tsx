                            ...
                            <div className="form-fix-group" key={col.key}>
                                ...
                                {col.type !== "select" ? (
                                    <input
                                        ...
                                        value={col.type == "date" ? (dataForm[col.key] ? dataForm[col.key].slice(0, 10) : "") : dataForm[col.key]}
                                        className="form-fix-input"
                                        onChange={(e) => setDataForm((prev: any) => ({ ...prev, [col.key]: e.target.value }))}
