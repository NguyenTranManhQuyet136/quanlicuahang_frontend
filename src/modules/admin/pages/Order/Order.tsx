...
const Order = () => {
    ...
    const closeForm = (type: any) => {
        switch (type) {
            case "remove":
                setRemoveStatus({ status: false, order_id: "", customer_id: "" });
                break;
            case "fix":
            ...
            case "search":
                ...
                break;
            case "detail":
                setDetailStatus({ status: false, id_target: "" });
                break;
        }
    };

    const handleRemove = async (order_id: any) => {
                ...
                <div className="p-4">
                    <div>
                        <div style={{ display: "flex", justifyContent: "flex-end", gap: "8px", marginBottom: "16px" }}>
                            <button style={{ display: "flex", alignItems: "center", gap: "6px", padding: "8px 16px", backgroundColor: "#0d6efd", color: "#fff", border: "none", borderRadius: "6px", cursor: "pointer", fontWeight: "500", fontSize: "0.95rem" }} onClick={() => setSearchStatus({ status: true })}>{(FiSearch as any)({ size: 18 })}Tìm kiếm</button>
                            <button style={{ display: "flex", alignItems: "center", gap: "6px", padding: "8px 16px", backgroundColor: "#0d6efd", color: "#fff", border: "none", borderRadius: "6px", cursor: "pointer", fontWeight: "500", fontSize: "0.95rem" }} onClick={() => window.location.replace("/Create-invoice")}>{(FiPlus as any)({ size: 18 })}Thêm đơn</button>
