...
const Warehouse = () => {
    ...
    const closeForm = (type: any) => {
        switch (type) {
            case "remove":
                setRemoveStatus({ status: false, warehouse_id: "", supplier_name: "" });
                break;
            case "fix":
    ...
    const handleRemove = async (warehouse_id: any) => {
                ...
                <div className="p-4">
                    <div>
                        <div style={{ display: "flex", justifyContent: "flex-end", gap: "8px", marginBottom: "16px" }}>
                            ...
                            <button style={{ display: "flex", alignItems: "center", gap: "6px", padding: "8px 16px", backgroundColor: "#0d6efd", color: "#fff", border: "none", borderRadius: "6px", cursor: "pointer", fontWeight: "500", fontSize: "0.95rem" }} onClick={() => setAddStatus({ status: true })}>{(FiPlus as any)({ size: 18 })}Thêm phiếu</button>
