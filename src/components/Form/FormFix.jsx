      ...
      <div className="card shadow" style={{ width: "400px" }}>
        ...
        <div className="card-body">
          <form>
                ...
                <div className="mb-3" key={col.key}>
                    ...
                    {col.type != 'select' ? ( 
                        <input
                            ...
                            onChange={(e) => 
                                setDataForm((prev) => ({...prev, [col.key]: e.target.value}))
                            }
                        />
                    ): (
                        <select
            ...
            <div type="button" className="d-flex justify-content-end">
                <button
                ...
                <button type="button" className="btn btn-primary" onClick={() => props.handleFix(dataForm,idOld)}>
                    Xác nhận
                </button>
            </div>
          </form>
